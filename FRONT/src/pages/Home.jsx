...
export default function Home() {
	...
	useEffect(() => {
		if (institutions?.length) setSelected({ ...institutions[0], index: 0 });
	}, [institutions]);
	...
	if (institutions?.length === 0 || !selected) return;
	...
	return (
		<div className='flex-col overflow-y-auto bg-gradient-to-b dark:from-zinc-400 dark:to-zinc-700 from-zinc-100 to-zinc-300 font-rubik w-svw h-svh'>
			...
			<div className='flex flex-col w-full gap-4 p-2 mt-[5.25rem]'>
