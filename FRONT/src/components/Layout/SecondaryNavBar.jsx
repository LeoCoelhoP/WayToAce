...
export default function SecondaryNavBar({
	...
	return (
		<div className='z-20 flex items-center justify-center w-full h-[2.63rem] gap-2 p-2 overflow-hidden rounded-md shadow-md bg-zinc-50 dark:bg-zinc-100 scroll-m-14'>
			{searching ? (
				<motion.form
					animate={{ y: 0 }}
